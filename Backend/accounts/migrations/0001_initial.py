    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='foodflex_user_set', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='foodflex_user_set', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'db_table': 'users',
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_balance', models.DecimalField(decimal_places=2, default=0.0, help_text='Real money earned from completed orders', max_digits=12)),
